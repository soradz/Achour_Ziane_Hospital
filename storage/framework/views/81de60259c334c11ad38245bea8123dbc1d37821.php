...
<?php $__env->startSection('title', 'تسجيل مريض - القسم الجراحي'); ?>
...
<div class="main">
    ...
    <div class="page-header">
        ...
        <div class="ph-btns">
            <a href="<?php echo e(route('patients.today', ['section'=>'surgical'])); ?>" class="btn-teal">📋 مرضى اليوم</a>
            ...
            <div class="row">
                <div class="field">
                    ...
                    <select name="status" class="field-input" required>
                        ...
                        <?php $__currentLoopData = ['كسر','جرح','حرق','بتر','نزيف داخلي','التهاب الزائدة','فتق','صدمة / إصابة','متابعة بعد عملية','عملية عاجلة','عدوى جراحية','جسم غريب','عملية عين','عملية أذن','عظام','أخرى']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\urgences-hospital\resources\views/patients/create_surgical.blade.php ENDPATH**/ ?>