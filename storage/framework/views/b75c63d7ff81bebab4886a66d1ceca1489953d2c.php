...
<?php $__env->startSection('title', 'الاستعجالات'); ?>
...
<div class="topbar" style="position:fixed;">
    <div class="tb-brand">
        ...
        <div>
            <div class="tb-name">أهلاً، <?php echo e(session('name')); ?></div>
            <div class="tb-badge">
                <div class="tb-badge-dot"></div>
                <?php if(session('role')==='admin'): ?> ADMIN — مدير النظام <?php else: ?> DOCTOR — طبيب <?php endif; ?>
            </div>
        </div>
    </div>
...
<h1 class="hero-title">نظام <span>الاستعجالات</span> — مستشفى عاشور زيان — أولاد جلال</h1>
    ...
    <div class="nav-grid">
        ...
        <a href="<?php echo e(route('triage')); ?>" class="nav-card c-triage">
            <div class="card-icon">
        ...
        <a href="<?php echo e(route('lab.one')); ?>" class="nav-card c-lab1">
            <div class="card-icon">
        ...
        <a href="<?php echo e(route('lab.two')); ?>" class="nav-card c-lab2">
            <div class="card-icon">
        ...
        <a href="<?php echo e(route('prescription.create')); ?>" class="nav-card c-rx">
            <div class="card-icon">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-card c-admin col-2">
            <div class="card-icon">
        ...
        <a href="<?php echo e(route('prescription.create')); ?>" class="nav-card c-rx card-wide col-full">
            <div class="card-icon">
                <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
            </div>
            <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\urgences-hospital\resources\views/home.blade.php ENDPATH**/ ?>