...
<div class="main">
    <div class="page-header">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="back-btn">↩ لوحة التحكم</a>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="<?php echo e(route('admin.users.store')); ?>">
            ...
            <div class="field">
                ...
                <input type="email" name="email" class="field-input" placeholder="example@hospital.com" value="<?php echo e(old('email')); ?>" required>
            </div>
            ...
            <div class="field">
                ...
                <select name="role" class="field-input" required>
                    ...
                    <option value="doctor"     <?php echo e(old('role') == 'doctor'     ? 'selected' : ''); ?>>🩺 دكتور</option>
                    <option value="admin"      <?php echo e(old('role') == 'admin'      ? 'selected' : ''); ?>>⚙️ أدمن</option>
                    <option value="lab_worker" <?php echo e(old('role') == 'lab_worker' ? 'selected' : ''); ?>>🧪 عامل مخبر</option>
                    <option value="lab_worker" <?php echo e(old('role') == 'lab_worker' ? 'selected' : ''); ?>>🧪 عامل مخبر</option>
                </select>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\urgences-hospital\resources\views/admin/create.blade.php ENDPATH**/ ?>