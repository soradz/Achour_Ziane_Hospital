...
<?php $__env->startSection('title', 'مكتب الفحوصات 1'); ?>
...
<div class="main">
    ...
    <div class="page-header">
        ...
        <div class="ph-info">
            ...
            <div class="ph-sub">أهلاً، <?php echo e(session('name')); ?> — LAB OFFICE 01</div>
        </div>
        <div class="ph-right">
            <?php if($patients->where('lab_office', '!=', 1)->whereNull('received_at')->count() > 0): ?>
            <a href="<?php echo e(route('patients.remaining')); ?>" class="alert-badge">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\urgences-hospital\resources\views/lab/one.blade.php ENDPATH**/ ?>