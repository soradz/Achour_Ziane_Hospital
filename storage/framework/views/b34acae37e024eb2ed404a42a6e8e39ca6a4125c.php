...
<?php $__env->startSection('title', 'المرضى المتبقين - مكتب الفحوصات 1'); ?>
...
<div class="main">
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('lab.one')); ?>" class="btn-back">
        ...
        <div class="table-scroll">
            <table>
                ...
                <tbody>
                    ...
                    <?php $isSent = $patient->lab_office == 1; ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                            <form method="POST" action="<?php echo e(route('lab.sendPatient', $patient->id)); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\urgences-hospital\resources\views/patients_remaining.blade.php ENDPATH**/ ?>