...
<div class="main">
    ...
    <div class="page-header">
        ...
        <div class="ph-info">
            ...
            <div class="ph-sub">RADIOLOGY RESULT — REF #{{ str_pad($xrayRequest->id, 6, '0', STR_PAD_LEFT) }}</div>
        </div>
        <div class="ph-actions">
            <a href="{{ route('doctor.xray.results.list') }}" class="btn-nav btn-back">
    ...
    <div class="patient-card">
        <div class="pc-row">
            ...
            <div class="pc-info">
                <div class="pc-name">{{ $xrayRequest->patient->first_name }} {{ $xrayRequest->patient->last_name }}</div>
                <div class="pc-meta">
                    <span>
                        <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                        {{ $xrayRequest->updated_at->format('Y-m-d') }} — {{ $xrayRequest->updated_at->format('H:i') }}
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="card" style="animation-delay:.2s">
        ...
        @if($xrayRequest->image_path)
            @php $ext = pathinfo($xrayRequest->image_path, PATHINFO_EXTENSION); @endphp
            @if(in_array(strtolower($ext), ['jpg','jpeg','png','gif','webp']))
            <div class="xray-image-wrap" onclick="openZoom('{{ asset('storage/'.$xrayRequest->image_path) }}')">
                <img src="{{ asset('storage/'.$xrayRequest->image_path) }}" alt="صورة الأشعة">
            </div>
            <div class="zoom-hint">
                <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>
            ...
            <div class="xray-image-wrap pdf-wrap">
                ...
                <div class="pdf-name">{{ basename($xrayRequest->image_path) }}</div>
                <a href="{{ asset('storage/'.$xrayRequest->image_path) }}" target="_blank" class="pdf-btn">
