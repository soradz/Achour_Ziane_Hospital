    ...
    <div class="form-card">
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <div class="field">
                ...
                <input type="email" name="email" class="field-input" placeholder="example@hospital.dz" value="{{ old('email') }}" required>
            </div>
            ...
            <div class="roles-grid">
                <div class="role-btn {{ old('role')==='doctor'?'selected':'' }}" onclick="selectRole(this,'doctor')">
                ...
                <div class="role-btn {{ old('role')==='admin'?'selected':'' }}" onclick="selectRole(this,'admin')">
                ...
                <div class="role-btn {{ old('role')==='lab_worker'?'selected':'' }}" onclick="selectRole(this,'lab_worker')">
                ...
                <div class="role-btn {{ old('role')==='xray_worker'?'selected':'' }}" onclick="selectRole(this,'xray_worker')">
