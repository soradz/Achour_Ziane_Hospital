@extends('layouts.app')
@section('title', 'المرضى المتبقين - مكتب الفحوصات 2')
@section('content')
<style>
...
<div class="main">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('lab.two') }}" class="btn-back">
        ...
        <div class="table-scroll">
            <table>
                ...
                <tbody>
                    ...
                    @php $isSent = $patient->sent_to_lab2 == 1; @endphp
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            <form method="POST" action="{{ route('lab.two.sendPatient', $patient->id) }}">
                                @csrf
