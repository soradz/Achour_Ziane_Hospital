...
<div class="main">
    ...
    <div class="page-header">
        ...
        <div class="ph-info">
            ...
            <div class="ph-sub">أهلاً، {{ session('name') }} — LAB OFFICE 02</div>
        </div>
        <div class="ph-right">
            @if($patients->filter(fn($p) => !$p->sent_to_lab2)->count() > 0)
            <a href="{{ route('two.patients.remaining') }}" class="alert-badge">
