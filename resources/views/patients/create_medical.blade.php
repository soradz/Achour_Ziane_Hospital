...
@section('title', 'تسجيل مريض - القسم الطبي')
...
<div class="main">
    ...
    <div class="page-header">
        ...
        <div class="ph-btns">
            <a href="{{ route('patients.today', ['section'=>'medical']) }}" class="btn-teal">📋 مرضى اليوم</a>
            ...
            <div class="row">
                <div class="field">
                    ...
                    <select name="status" class="field-input" required>
                        ...
                        @foreach(['حرق','تسمم','حمّى','إلتهاب','نزلة برد','صداع','سكري','ضغط دم','ربو','كسر','نزيف','حساسية','مشكلة عين','مشكلة أذن','ألم معدة','غثيان','إسهال','إصابة برد','ميغرين','أخرى'] as $s)
