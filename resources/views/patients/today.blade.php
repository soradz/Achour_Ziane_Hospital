...
@for($i=1;$i<=15;$i++)
tbody tr:nth-child({{$i}}){animation-delay:{{0.1+$i*0.04}}s}
@endfor
...
@php $isSurgical = $section !== 'medical'; @endphp
...
<div class="main">
    ...
    <!-- Header -->
    <div class="page-header {{ $isSurgical ? 'ph-surgical' : 'ph-medical' }}">
        ...
        <div class="ph-btns">
            <a href="{{ route('patients.create.' . $section) }}" class="btn-primary">
                <svg viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                تسجيل مريض جديد
            </a>
            <a href="{{ route('triage') }}" class="btn-secondary">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="td-name">
                                <div class="td-avatar {{ $patient->gender === 'أنثى' ? 'female' : '' }}">
                                    <svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                </div>
                                <span class="td-fullname">{{ $patient->first_name }} {{ $patient->last_name }}</span>
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            @else
                            <span style="color:var(--soft)">{{ $patient->gender }}</span>
                            @endif
                        </td>
                        <td>
                            @if(!empty($patient->status))
                            <span class="s-pill {{ $isSurgical ? 'sp-red' : 'sp-blue' }}">
                                <div class="sp-d"></div>{{ $patient->status }}
                            </span>
                            @else
